 ...
 *
 * Usage:
 *   <script src="shared/ecosystem-apps.js"></script>  <!-- load first -->
 ...
 *   HK.AppSwitcher                  — ecosystem app switcher (build/init)
 */
(function () {
  'use strict';
  ...
  // Ecosystem apps — loaded from shared/ecosystem-apps.js (single source of truth)
  var ECOSYSTEM_APPS = window.HK_ECOSYSTEM_APPS || [];
