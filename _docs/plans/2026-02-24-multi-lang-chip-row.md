...
**Files:**
- Modify: `site/shared/theme.js:38-48` (LANGUAGES array)
...
**Files:**
- Modify: `site/T5-activity-editor.html` (CSS section, lines ~445-461)
...
```bash
git add site/T5-activity-editor.html
...
**Files:**
- Modify: `site/T5-activity-editor.html` (JS section, lines ~569-918)
...
**Files:**
- Modify: `site/T5-activity-editor.html` — `buildEditForm` function (lines ~719-874)
...
**Files:**
- Modify: `site/T5-activity-editor.html` — `buildEditForm` function
...
**Files:**
- Modify: `site/T5-activity-editor.html` — render section (lines ~1007-1015)
...
**Files:**
- Modify: `site/T5-activity-editor.html`
...
|------|-------------|-------|
| 1 | Add language colors to theme.js | `site/shared/theme.js` |
| 2 | Add chip-row CSS | `site/T5-activity-editor.html` |
| 3 | Build chip-row JS functions | `site/T5-activity-editor.html` |
| 4 | Wire chip-row into buildEditForm | `site/T5-activity-editor.html` |
| 5 | Per-activity translate-all button | `site/T5-activity-editor.html` |
| 6 | Per-lesson translate-all button | `site/T5-activity-editor.html` |
| 7 | Clean up deprecated code + polish | `site/T5-activity-editor.html` |
