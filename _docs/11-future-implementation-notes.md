...
- `site/shared/header.js` is an IIFE that builds the header via string concatenation
...
- Shared CSS files in `site/shared/`: `header.css`, `footer.css`, `settings.css`
...
- **Tailwind CSS** with a custom theme config derived from `_docs/09-design-decisions.md`
